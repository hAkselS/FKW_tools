'''
File:   create_raven_annotatoins.py

Spec:   This program creates YOLO OBB annotations designed to work with the
        10 spectrogram strip images from Raven annotations. 
        SO FAR IT IS JUST CREATE_PAMGUARD_ANNOTATIONS

I/O:    

Note:   The last three digits is the AC number. Ex: 1705109 is LaskerAC109

Usage:  python3 model_training/create_raven_annotations.py #####TODO <folder/with/spectrograms> <path/to/csv>
'''
